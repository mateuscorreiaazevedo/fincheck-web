  ...
  return (
    <Dropdown.Portal>
      <Dropdown.Content
        {...props}
        className={cn(
          'h-auto w-full max-w-[var(--radix-dropdown-menu-trigger-width)] rounded-2xl border border-gray-1 bg-white shadow-default transition-all data-[side=bottom]:animate-slideUpAndFade data-[side=top]:animate-slideDownAndFade',
          className
        )}
      />
    </Dropdown.Portal>
